...
router.get('/getChampionship/:id', async (req, res) => {
    ...
    try {
        ...
        const teamsPromise = axios.get(`http://localhost:3001/api/championship/teams/${id}`);//teams in championship
        const matchesPromise = axios.get(`http://localhost:3001/api/championship/matches/${id}`);
